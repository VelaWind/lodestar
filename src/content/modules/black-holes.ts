    ...
    intuition: {
      body: prose(
        p(
          ...
          'the current itself reaches one metre per second — and past it, no fish returns. A fish ',
    ...
    play: {
      ...
      caption: prose(
        p(
          ...
          'innermost stable orbit — and check the readout that says whether arriving would kill ',
          'you.',
        ),
      ),
      params: [
    ...
    real: {
      body: prose(
        p(
          ...
          'relativity. It is not a material surface — nothing is there — and it is startlingly ',
          'small: the Sun’s works out to three kilometres, and the ten-solar-mass hole the slider ',
          'starts on spans a city, 29.5 kilometres in radius. Outside it sit two more landmarks. ',
    ...
    deeper: {
      body: prose(
        p(
          ...
          'centre is as unavoidable as reaching next Tuesday — for Sagittarius A*, at most about ',
          'a minute of proper time.',
        ),
        p(
        ...
        p(
          ...
          'information — forbidden by quantum mechanics. Hawking held for decades that the ',
